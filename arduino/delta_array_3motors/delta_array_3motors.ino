...
Adafruit_DCMotor* motors[NUM_MOTORS] = {NULL, NULL, NULL, MC1_M1, MC1_M2, MC1_M3, NULL, NULL, NULL, NULL, NULL, NULL};
...
Adafruit_ADS1015* adcs[NUM_MOTORS] = {NULL, NULL, NULL, &ADC0, &ADC0, &ADC0, NULL, NULL, NULL, NULL, NULL, NULL};
